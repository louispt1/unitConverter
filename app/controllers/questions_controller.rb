...
class QuestionsController < ApplicationController
  ...
  def displayConversion # Handle unit conversion and display result
      ...
      @converted_value = converted_value unless converted_value.nil?

  @conversion_occurred = true     # So the error message only shows up after a conversion has been attempted
  redirect_to root_path(converted_value: @converted_value, conversion_occurred: @conversion_occurred, input_value: @input_value, from_unit: @from_unit, to_unit: @to_unit)
  end
end
